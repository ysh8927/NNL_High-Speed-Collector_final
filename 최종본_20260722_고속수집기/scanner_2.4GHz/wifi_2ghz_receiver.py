...
class WideCSVWriter:
    ...
    def write(self, ts: str, mac: str, rssi: str, channel: str = ''):
        with self.lock:
            ...
            cell = f"{rssi}:{channel}" if channel != '' else rssi
            ...
            try:
                ...
                try:
                    ...
                    if ':' in parts[1]:
                        ...
                        writer.write(collection_time, mac, rssi, channel)
